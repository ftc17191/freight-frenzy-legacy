 ...
 *   The ETpark org.ftc17191.ftclayer.gamepad may only respond to rumble1, and may only run at full power.
 *   The Logitech F310 org.ftc17191.ftclayer.gamepad does not have *any* rumble ability.
 *
 ...
 *
 * The examples shown here are representstive of how to invoke a org.ftc17191.ftclayer.gamepad rumble.
 ...
 *          triggered by the org.ftc17191.ftclayer.gamepad A (Cross) button, but it could be any sensor, like a touch or light sensor.
...
public class ConceptGamepadRumble extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        {
            // Read and save the current org.ftc17191.ftclayer.gamepad button states.
            ...
            // ----------------------------------------------------------------------------------------
            // Example 4. Rumble once when org.ftc17191.ftclayer.gamepad right trigger goes above the THRESHOLD.
            // ----------------------------------------------------------------------------------------
